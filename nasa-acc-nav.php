...
if (!$product_image_id && $product->is_type('variation')) {
    // If variation has no image, get the parent product image
    $parent_id = $product->get_parent_id();
    $product_image_id = get_post_thumbnail_id($parent_id);
}
...
<div class="woocommerce-account-content">
    ...
    <!-- Inject real order data for JS -->
    <div id="real-recent-orders" style="display: none;">
        <?php
        ...
        foreach ($customer_orders as $order) :
            ...
            foreach ($order->get_items() as $item) :
                ...
                $img = wp_get_attachment_image_url(get_post_thumbnail_id($product->get_id()), 'thumbnail') ?: wc_placeholder_img_src();
        ?>
        <div class="orderinfo"
